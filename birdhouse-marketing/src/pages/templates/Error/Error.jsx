...
const html_template = "<html lang=\"en\" class=\"wf-barlow-n5-active wf-barlow-n7-active wf-lato-n4-active wf-montserratalternates-n8-active wf-poppins-n4-active wf-poppins-n5-active wf-poppins-n6-active wf-poppins-n7-active wf-poppins-i8-active wf-poppins-i4-active wf-active\" style=\"height: 100%; --font_default: &quot;Lato&quot;; --color_primary_default: rgba(2, 5, 211, 1); --color_primary_default_rgb: 2,5,211; --color_primary_contrast_default: rgba(255, 255, 255, 1); --color_primary_contrast_default_rgb: 255,255,255; --color_text_default: rgba(9, 23, 71, 1); --color_text_default_rgb: 9,23,71; --color_surface_default: rgba(255, 255, 255, 1); --color_surface_default_rgb: 255,255,255; --color_background_default: rgba(255, 255, 255, 0); --color_background_default_rgb: 255,255,255; --color_destructive_default: rgba(255, 0, 0, 1); --color_destructive_default_rgb: 255,0,0; --color_success_default: rgba(23, 219, 78, 1); --color_success_default_rgb: 23,219,78; --color_alert_default: rgba(250, 181, 21, 1); --color_alert_default_rgb: 250,181,21;\">\n" +
    ...
    "</head>\n" +
    "<body style=\"box-sizing: border-box; height: 100%;\" data-new-gr-c-s-check-loaded=\"14.1114.0\" data-gr-ext-installed=\"\">\n" +
    "<img style=\"display: none;\" src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\">\n" +
    "<div class=\"main-page bubble-element Page\" style=\"width: 1148px; height: 800px; min-height: 100%; margin-right: auto; margin-left: auto; position: absolute; z-index: 1; box-sizing: border-box; top: 0px; overflow: hidden; background: none rgb(255, 255, 255); opacity: 1;\">\n" +
    "  <div class=\"bubble-r-line\" style=\"margin-top: 0px; height: 563px;\">\n" +
    "    <div class=\"bubble-r-box\" style=\"height: 563px; left: 0px; width: 1148px;\">\n" +
    "      <div class=\"bubble-element CustomElement bubble-r-container flex row\" style=\"justify-content: center; height: max-content; grid-template-rows: max-content; width: 1148px; left: 0px; position: absolute; box-sizing: border-box; z-index: 2; top: 0px; background-color: rgb(255, 255, 255); border-radius: 0px; box-shadow: rgba(0, 0, 0, 0.05) 0px 4px 25px 0px; opacity: 1;\">\n" +
    ...
    "            <input type=\"input\" class=\"bubble-element Input\" style=\"z-index: 3; place-self: center end; min-width: 0px; max-width: 337px; min-height: 40px; width: calc(100% - 0px); height: calc(100% - 0px); margin: 0px; border: none; background-color: transparent; border-radius: 0px; font-family: Poppins; font-size: 14px; font-weight: 400; color: rgb(123, 123, 123); letter-spacing: 0.5px; opacity: 1;\" placeholder=\"Search ads, usernames, categories\" maxlength=\"\">\n" +
    ...
    "        </div>\n" +
    "      </div>\n" +
    "      <div class=\"bubble-element Group\" style=\"box-sizing: border-box; width: 1148px; left: 0px; position: absolute; z-index: 31; top: 0px; background: -webkit-linear-gradient(left, rgb(50, 67, 128) 0%, rgb(42, 61, 130) 100%); border-radius: 0px; opacity: 1; height: 563px;\">\n" +
    "        <div class=\"bubble-r-line\" style=\"margin-top: 182px; height: 318px;\">\n" +
    "          <div class=\"bubble-r-box\" style=\"height: 318px; left: 40px; width: 1068px;\">\n" +
    "            <div class=\"bubble-element Group\" style=\"box-sizing: border-box; position: absolute; z-index: 3; top: 0px; width: 1068px; left: 0px; border-radius: 0px; opacity: 1; height: 318px;\">\n" +
    "              <div class=\"bubble-r-line\" style=\"margin-top: 0px; height: 318px;\">\n" +
    "                <div class=\"bubble-r-box\" style=\"height: 318px; left: 0px; width: 548px;\">\n" +
    "                  <div class=\"bubble-element Group\" style=\"box-sizing: border-box; position: absolute; z-index: 4; top: 0px; width: 548px; left: 0px; border-radius: 0px; opacity: 1; height: 318px;\">\n" +
    "                    <div class=\"bubble-r-line\" style=\"margin-top: 48px; height: 78px;\">\n" +
    "                      <div class=\"bubble-r-box\" style=\"height: 78px; left: 0px; width: 548px;\">\n" +
    "                        <div class=\"bubble-element Text\" style=\"white-space: pre-wrap; position: absolute; box-sizing: border-box; z-index: 2; top: 0px; width: 548px; left: 0px; height: 78px; overflow: visible; font-family: Lato; font-size: 14px; font-weight: 400; color: rgb(37, 37, 37); line-height: 1; border-radius: 0px; opacity: 1;\">\n" +
    "                          <div class=\"content\">Oops! 404</div>\n" +
    "                        </div>\n" +
    "                      </div>\n" +
    "                    </div>\n" +
    "                    <div class=\"bubble-r-line\" style=\"margin-top: 5px; height: 40px;\">\n" +
    "                      <div class=\"bubble-r-box\" style=\"height: 40px; left: 0px; width: 548px;\">\n" +
    "                        <div class=\"bubble-element Text\" style=\"white-space: pre-wrap; position: absolute; box-sizing: border-box; z-index: 3; top: 0px; width: 548px; left: 0px; height: 40px; overflow: visible; font-family: Poppins; font-size: 22px; font-weight: 700; color: rgb(255, 255, 255); line-height: 1.5; border-radius: 0px; opacity: 1;\">\n" +
    "                          <div class=\"content\">It happens sometimes</div>\n" +
    "                        </div>\n" +
    "                      </div>\n" +
    "                    </div>\n" +
    "                    <div class=\"bubble-r-line\" style=\"margin-top: 1px; height: 85px;\">\n" +
    "                      <div class=\"bubble-r-box\" style=\"height: 85px; left: 0px; width: 400px;\">\n" +
    "                        <div class=\"bubble-element Text\" style=\"white-space: pre-wrap; position: absolute; box-sizing: border-box; z-index: 4; top: 0px; width: 400px; left: 0px; height: 85px; overflow: visible; font-family: Lato; font-size: 14px; font-weight: 400; color: rgb(37, 37, 37); line-height: 1; border-radius: 0px; opacity: 1;\">\n" +
    "                          <div class=\"content\">This page has got everything you need to get started. If you're already a Bubble Pro you can delete this boilerplate and design your own 404.</div>\n" +
    "                        </div>\n" +
    "                      </div>\n" +
    "                    </div>\n" +
    "                  </div>\n" +
    ...
    "    </div>\n" +
    "  </div>\n" +
    "  <div class=\"bubble-r-line\" style=\"margin-top: 0px; height: 237px;\">\n" +
    "    <div class=\"bubble-r-box\" style=\"height: 237px; left: 0px; width: 1148px;\">\n" +
    "      <div class=\"bubble-element CustomElement bubble-r-container flex column\" style=\"justify-content: flex-start; height: max-content; grid-template-rows: max-content; width: 1148px; left: 0px; position: absolute; box-sizing: border-box; z-index: 3; top: 0px; border-top: 1px solid rgb(246, 246, 246); border-radius: 0px; opacity: 1;\">\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 9; order: 2; height: max-content; flex-shrink: 0; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1; align-self: flex-start; min-width: 300px; max-width: 1180px; min-height: 0px; flex-grow: 0; width: calc(100% - 20px); margin: 23px 10px;\">\n" +
