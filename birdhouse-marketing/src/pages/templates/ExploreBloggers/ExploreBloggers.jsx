...
const html_template = "<html lang=\"en\" class=\"wf-barlow-n5-inactive wf-barlow-n7-inactive wf-lato-n4-inactive wf-montserratalternates-n8-inactive wf-poppins-n4-inactive wf-poppins-n5-inactive wf-poppins-n6-inactive wf-poppins-n7-inactive wf-poppins-i8-inactive wf-poppins-i4-inactive wf-inactive\" style=\"height: 100%; --color_primary_default: rgba(2, 5, 211, 1); --color_primary_default_rgb: 2,5,211; --color_primary_contrast_default: rgba(255, 255, 255, 1); --color_primary_contrast_default_rgb: 255,255,255; --color_text_default: rgba(9, 23, 71, 1); --color_text_default_rgb: 9,23,71; --color_surface_default: rgba(255, 255, 255, 1); --color_surface_default_rgb: 255,255,255; --color_background_default: rgba(255, 255, 255, 0); --color_background_default_rgb: 255,255,255; --color_destructive_default: rgba(255, 0, 0, 1); --color_destructive_default_rgb: 255,0,0; --color_success_default: rgba(23, 219, 78, 1); --color_success_default_rgb: 23,219,78; --color_alert_default: rgba(250, 181, 21, 1); --color_alert_default_rgb: 250,181,21; --font_default: &quot;Lato&quot;;\">\n" +
    ...
    "      <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 2; align-self: center; min-width: 82px; max-width: 82px; order: 1; min-height: 28px; width: 82px; flex-grow: 1; height: max-content; margin: 0px; justify-content: center; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    ...
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container fixed clickable-element\" style=\"z-index: 4; align-self: center; min-width: 40px; max-width: 40px; order: 4; min-height: 40px; max-height: 40px; width: 40px; flex-grow: 1; height: 40px; margin: 0px; overflow: visible; border-radius: 100px; padding: 0px; opacity: 1; cursor: pointer; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647552379244x207864892994998200/Group%20462.svg&quot;);\"></div>\n" +
    ...
    "      </div>\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 7; align-self: center; min-width: 0px; order: 4; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1; display: none; visibility: hidden;\">\n" +
    "        <div class=\"bubble-element Group bubble-r-container fixed clickable-element\" style=\"z-index: 4; align-self: center; min-width: 25px; max-width: 25px; order: 1; min-height: 23px; max-height: 23px; width: 25px; flex-grow: 1; height: 23px; margin: 0px 14px 0px 0px; overflow: visible; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647387433266x621007601971848000/search.svg&quot;); border-radius: 0px; padding: 0px; opacity: 1; cursor: pointer;\"></div>\n" +
    "        <div class=\"bubble-element Image clickable-element\" style=\"z-index: 6; align-self: center; min-width: 18px; max-width: 18px; order: 2; min-height: 14px; max-height: 14px; width: 18px; flex-grow: 1; height: 14px; margin: 0px; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "          <img alt=\"\" src=\"https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647388876880x324326889344323200/Vector.svg\" style=\"position: absolute; top: 0px; left: 0px; display: block; width: 100%; height: 100%; margin: 0px; border-radius: 0px;\">\n" +
    "          <div style=\"display: none;\"></div>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "  <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 3; align-self: center; min-width: 320px; max-width: 1200px; order: 2; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 150px 0px 30px; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "    <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; max-width: 280px; order: 1; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 10px; justify-content: flex-start; overflow: visible; border-radius: 0px; border-bottom: 1px solid rgb(238, 238, 238); padding: 0px 0px 10px; opacity: 1;\">\n" +
    "      <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 24px; font-weight: 500; color: rgb(0, 0, 0); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Explore Bloggers</div>\n" +
    "    </div>\n" +
    "    <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 3; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 10px; justify-content: space-between; overflow: visible; border-radius: 0px; border-bottom: 1px solid rgb(238, 238, 238); padding: 0px 0px 13px; opacity: 1;\">\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 10; align-self: flex-end; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 7; align-self: flex-end; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 15px 10px 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; padding: 7px 10px 7px 0px; opacity: 1; cursor: pointer; display: none; visibility: hidden;\">\n" +
    "          <div class=\"bubble-element HTML\" style=\"z-index: 2; align-self: flex-start; min-width: 24px; max-width: 24px; order: 1; min-height: 24px; max-height: 24px; width: 24px; flex-grow: 1; height: 24px; margin: 0px; border-radius: 0px; opacity: 1;\">\n" +
    "            <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    "              <path d=\"M11.45 4V10.9091H12.55V4H11.45ZM11.45 13.8182V20H12.55V13.8182H11.45ZM12 13.2682C11.5004 13.2682 11.0954 12.8632 11.0954 12.3636H9.99545C9.99545 13.4707 10.8929 14.3682 12 14.3682V13.2682ZM12.9045 12.3636C12.9045 12.8632 12.4996 13.2682 12 13.2682V14.3682C13.1071 14.3682 14.0045 13.4707 14.0045 12.3636H12.9045ZM12 11.4591C12.4996 11.4591 12.9045 11.8641 12.9045 12.3636H14.0045C14.0045 11.2566 13.1071 10.3591 12 10.3591V11.4591ZM12 10.3591C10.8929 10.3591 9.99545 11.2566 9.99545 12.3636H11.0954C11.0954 11.8641 11.5004 11.4591 12 11.4591V10.3591ZM17.9954 4V14.5909H19.0954V4H17.9954ZM17.9954 17.5V20H19.0954V17.5H17.9954ZM18.5454 16.95C18.0459 16.95 17.6409 16.545 17.6409 16.0455H16.5409C16.5409 17.1525 17.4384 18.05 18.5454 18.05V16.95ZM19.45 16.0455C19.45 16.545 19.045 16.95 18.5454 16.95V18.05C19.6525 18.05 20.55 17.1525 20.55 16.0455H19.45ZM18.5454 15.1409C19.045 15.1409 19.45 15.5459 19.45 16.0455H20.55C20.55 14.9384 19.6525 14.0409 18.5454 14.0409V15.1409ZM18.5454 14.0409C17.4384 14.0409 16.5409 14.9384 16.5409 16.0455H17.6409C17.6409 15.5459 18.0459 15.1409 18.5454 15.1409V14.0409ZM4.90454 4L4.90455 6.5L6.00455 6.5L6.00454 4L4.90454 4ZM4.90455 9.40909L4.90454 20H6.00454L6.00455 9.40909L4.90455 9.40909ZM5.45455 8.85909C4.95498 8.85909 4.55 8.45411 4.55 7.95455H3.45C3.45 9.06163 4.34747 9.95909 5.45455 9.95909V8.85909ZM6.35909 7.95455C6.35909 8.45411 5.95411 8.85909 5.45455 8.85909V9.95909C6.56163 9.95909 7.45909 9.06163 7.45909 7.95455H6.35909ZM5.45455 7.05C5.95411 7.05 6.35909 7.45498 6.35909 7.95455H7.45909C7.45909 6.84747 6.56163 5.95 5.45455 5.95V7.05ZM5.45455 5.95C4.34747 5.95 3.45 6.84747 3.45 7.95455H4.55C4.55 7.45498 4.95498 7.05 5.45455 7.05V5.95Z\" fill=\"#212121\"></path>\n" +
    "            </svg>\n" +
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 6; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 15px 10px 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; padding: 7px 10px 7px 0px; opacity: 1;\">\n" +
    "          <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; font-family: Poppins; font-size: 14px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1; word-break: break-word;\"> Selected 0 Ads</div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 3; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 15px 10px 0px; justify-content: flex-start; overflow: visible; border-style: solid; border-width: 1px; border-color: rgb(238, 238, 238); border-radius: 10px; padding: 7px 10px; opacity: 1; display: none; visibility: hidden;\">\n" +
    "          <div class=\"bubble-element Text\" style=\"z-index: 3; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; font-family: Poppins; font-size: 14px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1; word-break: break-word;\"></div>\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative clickable-element\" style=\"z-index: 4; align-self: flex-start; min-width: 24px; max-width: 24px; order: 4; min-height: 24px; max-height: 24px; width: 24px; flex-grow: 1; height: 24px; margin: 0px 0px 0px 10px; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "            <div class=\"bubble-element HTML\" style=\"z-index: 2; place-self: center; min-width: 24px; min-height: 24px; width: calc(100% - 0px); height: calc(100% - 0px); margin: 0px; border-radius: 0px; opacity: 1;\">\n" +
    "              <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    ...
    "        </div>\n" +
    "      </div>\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 11; align-self: center; min-width: 0px; order: 4; min-height: 28px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 26; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 20px 10px 0px; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "          <div class=\"bubble-element Text\" style=\"z-index: 3; align-self: center; min-width: 158px; order: 2; min-height: 0px; max-height: 30px; width: 158px; flex-grow: 1; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; font-family: Poppins; font-size: 15px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1; word-break: break-word;\">\n" +
    "            <div>Name: A - Z</div>\n" +
    "          </div>\n" +
    "          <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 3; align-self: center; min-width: 24px; max-width: 24px; order: 3; min-height: 24px; max-height: 24px; width: 24px; flex-grow: 1; height: 24px; margin: 0px 0px 0px 10px; overflow: visible; border-radius: 0px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647516484530x217959983199276220/Carret%20Down.svg&quot;);\"></div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 28; align-self: flex-start; min-width: 28px; order: 2; min-height: 28px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 15px 10px 0px; justify-content: center; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "          <div class=\"bubble-element HTML\" style=\"z-index: 7; align-self: center; min-width: 0px; max-width: 16px; order: 1; min-height: 16px; max-height: 16px; width: 0px; flex-grow: 1; height: 16px; margin: 0px; border-radius: 0px; opacity: 1;\">\n" +
    "            <svg width=\"16\" height=\"16\" viewBox=\"0 0 16 16\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    "              <rect x=\"0.5\" y=\"0.5\" width=\"15.5\" height=\"3\" rx=\"1.5\" stroke=\"#BBBBBB\"></rect>\n" +
    "              <rect x=\"0.5\" y=\"6.5\" width=\"15.5\" height=\"3\" rx=\"1.5\" stroke=\"#BBBBBB\"></rect>\n" +
    "              <rect x=\"0.5\" y=\"12.5\" width=\"15.5\" height=\"3\" rx=\"1.5\" stroke=\"#BBBBBB\"></rect>\n" +
    "            </svg>\n" +
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 8; align-self: flex-start; min-width: 28px; order: 3; min-height: 28px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 15px 10px 0px; justify-content: center; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "          <div class=\"bubble-element HTML\" style=\"z-index: 7; align-self: center; min-width: 0px; max-width: 16px; order: 1; min-height: 16px; max-height: 16px; width: 0px; flex-grow: 1; height: 16px; margin: 0px; border-radius: 0px; opacity: 1;\">\n" +
    "            <svg width=\"16\" height=\"16\" viewBox=\"0 0 16 16\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    "              <rect x=\"0.5\" y=\"0.5\" width=\"6\" height=\"6\" rx=\"3\" stroke=\"#BBBBBB\"></rect>\n" +
    "              <rect x=\"9.5\" y=\"0.5\" width=\"6\" height=\"6\" rx=\"3\" stroke=\"#BBBBBB\"></rect>\n" +
    "              <rect x=\"0.5\" y=\"9.5\" width=\"6\" height=\"6\" rx=\"3\" stroke=\"#BBBBBB\"></rect>\n" +
    "              <rect x=\"9.5\" y=\"9.5\" width=\"6\" height=\"6\" rx=\"3\" stroke=\"#BBBBBB\"></rect>\n" +
    "            </svg>\n" +
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 9; align-self: flex-start; min-width: 28px; order: 4; min-height: 28px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 15px 10px 0px; justify-content: center; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "          <div class=\"bubble-element HTML\" style=\"z-index: 7; align-self: center; min-width: 0px; max-width: 16px; order: 1; min-height: 16px; max-height: 16px; width: 0px; flex-grow: 1; height: 16px; margin: 0px; border-radius: 0px; opacity: 1;\">\n" +
    "            <svg width=\"16\" height=\"16\" viewBox=\"0 0 16 16\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    "              <rect x=\"0.5\" y=\"0.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint0_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"6.5\" y=\"0.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint1_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"12.5\" y=\"0.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint2_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"0.5\" y=\"6.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint3_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"6.5\" y=\"6.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint4_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"12.5\" y=\"6.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint5_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"0.5\" y=\"12.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint6_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"6.5\" y=\"12.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint7_linear_190_2192)\"></rect>\n" +
    "              <rect x=\"12.5\" y=\"12.5\" width=\"3\" height=\"3\" rx=\"1.5\" stroke=\"url(#paint8_linear_190_2192)\"></rect>\n" +
    "              <defs>\n" +
    "                <linearGradient id=\"paint0_linear_190_2192\" x1=\"-1.21429\" y1=\"-0.888889\" x2=\"5.28661\" y2=\"-0.354346\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint1_linear_190_2192\" x1=\"4.78571\" y1=\"-0.888889\" x2=\"11.2866\" y2=\"-0.354346\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint2_linear_190_2192\" x1=\"10.7857\" y1=\"-0.888889\" x2=\"17.2866\" y2=\"-0.354346\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint3_linear_190_2192\" x1=\"-1.21429\" y1=\"5.11111\" x2=\"5.28661\" y2=\"5.64565\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint4_linear_190_2192\" x1=\"4.78571\" y1=\"5.11111\" x2=\"11.2866\" y2=\"5.64565\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint5_linear_190_2192\" x1=\"10.7857\" y1=\"5.11111\" x2=\"17.2866\" y2=\"5.64565\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint6_linear_190_2192\" x1=\"-1.21429\" y1=\"11.1111\" x2=\"5.28661\" y2=\"11.6457\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint7_linear_190_2192\" x1=\"4.78571\" y1=\"11.1111\" x2=\"11.2866\" y2=\"11.6457\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    "                <linearGradient id=\"paint8_linear_190_2192\" x1=\"10.7857\" y1=\"11.1111\" x2=\"17.2866\" y2=\"11.6457\" gradientUnits=\"userSpaceOnUse\">\n" +
    "                  <stop stop-color=\"#2D2DFF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                  <stop offset=\"1\" stop-color=\"#00D4FF\"></stop>\n" +
    "                </linearGradient>\n" +
    ...
    "    </div>\n" +
    "  </div>\n" +
    "  <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: center; min-width: 320px; max-width: 1200px; order: 3; min-height: 150px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 100px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "    <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 4; align-self: flex-start; min-width: 0px; max-width: 280px; order: 1; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 10px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 3; align-self: flex-start; min-width: 0px; order: 2; min-height: 200px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 12; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 20px; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "          <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 16px; font-weight: 500; color: rgb(0, 0, 0); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Category</div>\n" +
    "          <div class=\"bubble-element Text\" id=\"gradient-text\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 16px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">-</div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element RepeatingGroup bubble-rg\" id=\"\" style=\"z-index: 12; align-self: flex-start; min-width: 0px; order: 2; min-height: 140px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 40px; gap: 0px; grid-auto-rows: minmax(max-content, 0px); grid-template-columns: repeat(1, minmax(0px, 1fr)); grid-auto-flow: row; overflow: auto; border-radius: 0px; opacity: 1;\">\n" +
    "          <div class=\"bubble-element GroupItem bubble-r-container flex row group-item entry-1\" style=\"justify-content: center; box-sizing: content-box; min-height: 0px; border-top-style: none; border-left-style: none;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 15px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 3; align-self: center; min-width: 20px; max-width: 20px; order: 1; min-height: 20px; max-height: 20px; width: 20px; flex-grow: 1; height: 20px; margin: 0px; overflow: visible; border-radius: 5px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647622827242x413982903324391200/Rectangle%20368.svg&quot;);\"></div>\n" +
    "              <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 0px 12px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 15px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Beauty</div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"bubble-element GroupItem bubble-r-container flex row group-item entry-2\" style=\"justify-content: center; box-sizing: content-box; min-height: 0px; border-top: 0px none rgba(150, 150, 150, 0.5); margin-top: 0px; border-left-style: none;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 15px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 3; align-self: center; min-width: 20px; max-width: 20px; order: 1; min-height: 20px; max-height: 20px; width: 20px; flex-grow: 1; height: 20px; margin: 0px; overflow: visible; border-radius: 5px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647622827242x413982903324391200/Rectangle%20368.svg&quot;);\"></div>\n" +
    "              <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 0px 12px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 15px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Crypto</div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"bubble-element GroupItem bubble-r-container flex row group-item entry-3\" style=\"justify-content: center; box-sizing: content-box; min-height: 0px; border-top: 0px none rgba(150, 150, 150, 0.5); margin-top: 0px; border-left-style: none;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 15px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 3; align-self: center; min-width: 20px; max-width: 20px; order: 1; min-height: 20px; max-height: 20px; width: 20px; flex-grow: 1; height: 20px; margin: 0px; overflow: visible; border-radius: 5px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647622827242x413982903324391200/Rectangle%20368.svg&quot;);\"></div>\n" +
    "              <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 0px 12px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 15px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Fashion</div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"bubble-element GroupItem bubble-r-container flex row group-item entry-4\" style=\"justify-content: center; box-sizing: content-box; min-height: 0px; border-top: 0px none rgba(150, 150, 150, 0.5); margin-top: 0px; border-left-style: none;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 15px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 3; align-self: center; min-width: 20px; max-width: 20px; order: 1; min-height: 20px; max-height: 20px; width: 20px; flex-grow: 1; height: 20px; margin: 0px; overflow: visible; border-radius: 5px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647622827242x413982903324391200/Rectangle%20368.svg&quot;);\"></div>\n" +
    "              <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 0px 12px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 15px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Lifestyle</div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"bubble-element GroupItem bubble-r-container flex row group-item entry-5\" style=\"justify-content: center; box-sizing: content-box; min-height: 0px; border-top: 0px none rgba(150, 150, 150, 0.5); margin-top: 0px; border-left-style: none;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 15px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 3; align-self: center; min-width: 20px; max-width: 20px; order: 1; min-height: 20px; max-height: 20px; width: 20px; flex-grow: 1; height: 20px; margin: 0px; overflow: visible; border-radius: 5px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647622827242x413982903324391200/Rectangle%20368.svg&quot;);\"></div>\n" +
    "              <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 0px 12px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 15px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Music</div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"bubble-element GroupItem bubble-r-container flex row group-item entry-6\" style=\"justify-content: center; box-sizing: content-box; min-height: 0px; border-top: 0px none rgba(150, 150, 150, 0.5); margin-top: 0px; border-left-style: none;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 15px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 3; align-self: center; min-width: 20px; max-width: 20px; order: 1; min-height: 20px; max-height: 20px; width: 20px; flex-grow: 1; height: 20px; margin: 0px; overflow: visible; border-radius: 5px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-repeat: no-repeat; background-size: cover; background-image: url(&quot;https://38a0942e450bdb16ca9cf24659307840.cdn.bubble.io/f1647622827242x413982903324391200/Rectangle%20368.svg&quot;);\"></div>\n" +
    "              <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 0px 0px 12px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 15px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Other</div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 7; align-self: flex-start; min-width: 0px; order: 3; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 20px; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "          <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 16px; font-weight: 500; color: rgb(0, 0, 0); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1;\">Price</div>\n" +
    "          <div class=\"bubble-element Text clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 16px; font-weight: 500; color: rgb(123, 123, 123); letter-spacing: 1px; line-height: 1.5; border-radius: 0px; opacity: 1; cursor: pointer;\" id=\"gradient-text\">-</div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 8; align-self: flex-start; min-width: 0px; order: 4; min-height: 100px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 50px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container flex row clickable-element\" style=\"z-index: 24; align-self: flex-start; min-width: 0px; order: 1; min-height: 50px; height: 50px; flex-grow: 1; width: calc(100% - 0px); margin: 0px 0px 20px; justify-content: space-between; overflow: visible; background-color: rgba(255, 255, 255, 0.7); border-style: solid; border-width: 1px; border-color: rgb(238, 238, 238); border-radius: 15px; opacity: 1; cursor: pointer;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 30px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 0px 0px 20px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container fixed\" style=\"z-index: 2; align-self: center; min-width: 24px; max-width: 24px; order: 1; min-height: 24px; max-height: 24px; width: 24px; flex-grow: 1; height: 24px; margin: 0px; overflow: visible; border-style: solid; border-width: 1px; border-color: rgb(238, 238, 238); border-radius: 20px; padding: 0px; opacity: 1; background-color: rgba(255, 255, 255, 0); background-image: url(&quot;https://d1muf25xaso8hp.cloudfront.net/https%3A%2F%2F38a0942e450bdb16ca9cf24659307840.cdn.bubble.io%2Ff1657633985492x211575392420328060%2F25228.png?w=32&amp;h=32&amp;auto=compress&amp;fit=crop&amp;dpr=2&quot;); background-size: cover; background-repeat: no-repeat; background-attachment: initial; background-origin: initial; background-clip: initial;\"></div>\n" +
    ...
    "          </div>\n" +
    "          <div class=\"bubble-element SliderInput clickable-element\" style=\"z-index: 25; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px; padding: 8px; opacity: 1;\">\n" +
    "            <div class=\"jquery-slider ui-slider ui-corner-all ui-widget ui-widget-content ui-slider-horizontal\" style=\"margin-left: 3px; margin-right: 3px; cursor: pointer; background: rgb(255, 255, 255); border-color: rgb(222, 222, 222); height: 100%; width: calc(100% - 7px);\">\n" +
    "              <span tabindex=\"0\" class=\"ui-slider-handle ui-corner-all ui-state-default\" style=\"left: 0%; cursor: pointer; outline: none; border-color: rgb(222, 222, 222); top: -8px; height: calc(100% + 16px); width: 19px; background: rgb(230, 230, 230);\"></span>\n" +
    "              <div class=\"ui-slider-range ui-corner-all ui-widget-header\" style=\"width: 100%; background: rgb(204, 204, 204); left: 0%; height: 100%;\"></div>\n" +
    "              <span tabindex=\"0\" class=\"ui-slider-handle ui-corner-all ui-state-default\" style=\"left: 100%; cursor: pointer; outline: none; border-color: rgb(222, 222, 222); top: -8px; height: calc(100% + 16px); width: 19px; background: rgb(230, 230, 230);\"></span>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 13; align-self: flex-start; min-width: 10px; order: 10; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "          <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 13; align-self: flex-start; min-width: 10px; order: 11; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "          <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 13; align-self: flex-start; min-width: 10px; order: 12; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "          <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 13; align-self: flex-start; min-width: 10px; order: 13; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 9; align-self: flex-start; min-width: 10px; order: 5; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "        <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 10; align-self: flex-start; min-width: 10px; order: 6; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "        <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 13; align-self: flex-start; min-width: 10px; order: 7; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "        <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 11; align-self: flex-start; min-width: 10px; order: 8; min-height: 10px; max-height: 1px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; display: none;\"></div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "    <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 2; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px 10px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "      <div class=\"bubble-element Text\" style=\"z-index: 30; align-self: center; min-width: 0px; order: 2; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: auto; margin: 0px; white-space: pre-wrap; overflow: visible; word-break: break-word; font-family: Poppins; font-size: 16px; font-weight: 500; color: rgb(0, 0, 0); letter-spacing: 0.5px; line-height: 1.5; border-radius: 0px; opacity: 1;\">No ads found.</div>\n" +
    "      <div class=\"bubble-element RepeatingGroup bubble-rg\" style=\"z-index: 18; align-self: flex-start; min-width: 0px; order: 3; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 10px; gap: 20px; grid-auto-rows: minmax(max-content, 280px); grid-template-columns: repeat(3, minmax(0px, 1fr)); grid-auto-flow: row; overflow: auto; border-radius: 0px; opacity: 1;\">\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-1\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top-style: none; border-left-style: none; display: none;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative clickable-element\" style=\"z-index: 2; align-self: center; min-width: 280px; max-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: 280px; margin: 0px; overflow: visible; border-radius: 20px; opacity: 1; cursor: pointer;\">\n" +
    ...
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; font-family: Poppins; font-size: 14px; font-weight: 600; color: rgb(255, 255, 255); line-height: 1; border-radius: 0px; opacity: 1;\"></div>\n" +
    ...
    "                    <img alt=\"\" style=\"border-radius: 0px;\">\n" +
    "                    <div style=\"position: relative; padding-top: 100%;\"></div>\n" +
    "                  </div>\n" +
    "                  <div class=\"bubble-element Text\" style=\"z-index: 3; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px; white-space: pre-wrap; overflow: visible; font-family: Poppins; font-size: 14px; font-weight: 600; color: rgb(255, 255, 255); text-align: right; line-height: 1; border-radius: 0px; opacity: 1;\"></div>\n" +
    "                </div>\n" +
    "              </div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    ...
    "          <div class=\"bubble-element Group bubble-r-container relative\" style=\"z-index: 2; align-self: center; min-width: 280px; max-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: 280px; margin: 0px;\">\n" +
    ...
    "        </div>\n" +
    "      </div>\n" +
    "      <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 19; align-self: flex-start; min-width: 0px; order: 4; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 10px; display: none;\"></div>\n" +
    "      <div class=\"bubble-element RepeatingGroup\" style=\"visibility: hidden; z-index: 32; align-self: flex-start; min-width: 0px; order: 5; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 10px; display: none;\"></div>\n" +
    "      <div class=\"bubble-element RepeatingGroup bubble-rg\" style=\"z-index: 20; align-self: flex-start; min-width: 0px; order: 6; min-height: 280px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px 0px 10px; gap: 20px; grid-auto-rows: minmax(max-content, 280px); grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); grid-auto-flow: row; overflow: auto; border-radius: 0px; opacity: 1; display: none; visibility: hidden;\">\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-1\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top-style: none; border-left-style: none; display: none;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative clickable-element\" style=\"z-index: 2; align-self: center; min-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px; overflow: visible; border-radius: 20px; opacity: 1; cursor: pointer;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 16; place-self: end center; min-width: 0px; min-height: 0px; width: calc(100% - 0px); height: max-content; margin: 0px; justify-content: flex-start; overflow: visible; background: -webkit-linear-gradient(top, rgba(33, 33, 33, 0) 0%, rgb(33, 33, 33) 100%); border-radius: 20px; padding: 15px 12px; opacity: 1;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 17px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1;\">\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px; white-space: pre-wrap; overflow: visible; font-family: Poppins; font-size: 12px; font-weight: 600; color: rgba(255, 255, 255, 0.77); line-height: 1; border-radius: 0px; opacity: 1;\"></div>\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px; white-space: pre-wrap; overflow: visible; font-family: Poppins; font-size: 12px; font-weight: 600; color: rgba(255, 255, 255, 0.77); line-height: 1; border-radius: 0px; opacity: 1;\"></div>\n" +
    ...
    "        </div>\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-2\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top-style: none; border-left: 20px solid rgba(150, 150, 150, 0); margin-left: -20px; display: none;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative\" style=\"z-index: 2; align-self: center; min-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 16; place-self: end center; min-width: 0px; min-height: 0px; width: calc(100% - 0px); height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 17px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: space-between;\">\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px;\"></div>\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 4; align-self: center; min-width: 0px; order: 2; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px;\"></div>\n" +
    ...
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-3\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top: 20px none rgba(150, 150, 150, 0); border-left: 20px solid rgba(150, 150, 150, 0); display: none; margin-left: -20px;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative\" style=\"z-index: 2; align-self: center; min-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 16; place-self: end center; min-width: 0px; min-height: 0px; width: calc(100% - 0px); height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 17px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: space-between;\">\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px;\"></div>\n" +
    ...
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-4\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top: 20px solid rgba(150, 150, 150, 0); border-left: 20px none rgba(150, 150, 150, 0); display: none; margin-top: -20px;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative\" style=\"z-index: 2; align-self: center; min-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 16; place-self: end center; min-width: 0px; min-height: 0px; width: calc(100% - 0px); height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 17px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: space-between;\">\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px;\"></div>\n" +
    ...
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-5\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top: 20px solid rgba(150, 150, 150, 0); border-left: 20px solid rgba(150, 150, 150, 0); display: none; margin-top: -20px; margin-left: -20px;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative\" style=\"z-index: 2; align-self: center; min-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 16; place-self: end center; min-width: 0px; min-height: 0px; width: calc(100% - 0px); height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 17px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: space-between;\">\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px;\"></div>\n" +
    ...
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-6\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top: 20px solid rgba(150, 150, 150, 0); border-left: 20px solid rgba(150, 150, 150, 0); margin-left: -20px; display: none; margin-top: -20px;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative\" style=\"z-index: 2; align-self: center; min-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 16; place-self: end center; min-width: 0px; min-height: 0px; width: calc(100% - 0px); height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 17px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: space-between;\">\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px;\"></div>\n" +
    ...
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element GroupItem bubble-r-container flex column group-item entry-7\" style=\"justify-content: flex-start; box-sizing: content-box; min-height: 280px; border-top: 20px solid rgba(150, 150, 150, 0); border-left-style: none; display: none; margin-top: -20px;\">\n" +
    "          <div class=\"bubble-element Group bubble-r-container relative\" style=\"z-index: 2; align-self: center; min-width: 280px; order: 1; min-height: 0px; height: 0px; flex-grow: 1; width: calc(100% - 0px); margin: 0px;\">\n" +
    "            <div class=\"bubble-element Group bubble-r-container flex column\" style=\"z-index: 16; place-self: end center; min-width: 0px; min-height: 0px; width: calc(100% - 0px); height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "              <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-end; min-width: 0px; order: 1; min-height: 17px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: space-between;\">\n" +
    "                <div class=\"bubble-element Text\" style=\"z-index: 2; align-self: center; min-width: 0px; order: 1; min-height: 0px; width: max-content; flex-grow: 0; height: max-content; margin: 0px 10px 0px 0px;\"></div>\n" +
    ...
    "    </div>\n" +
    "  </div>\n" +
    "  <div class=\"bubble-element CustomElement bubble-r-container flex column\" style=\"z-index: 4; align-self: center; min-width: 0px; max-width: 1200px; order: 5; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: flex-start; overflow: visible; border-top: 1px solid rgb(246, 246, 246); border-radius: 0px; opacity: 1; background: none transparent;\">\n" +
    "    <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 10; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; padding: 10px 0px; opacity: 1; display: none; visibility: hidden;\">\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex column clickable-element\" style=\"z-index: 2; align-self: flex-start; min-width: 0px; order: 1; min-height: 50px; width: 0px; flex-grow: 1; height: max-content; margin: 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "        <div class=\"bubble-element HTML\" style=\"z-index: 2; align-self: center; min-width: 24px; max-width: 24px; order: 1; min-height: 24px; max-height: 24px; height: 24px; flex-grow: 1; width: 24px; margin: 0px 0px 10px; border-radius: 0px; opacity: 1;\">\n" +
    "          <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    ...
    "          </svg>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Text\" style=\"z-index: 6; align-self: center; min-width: 0px; order: 2; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: auto; margin: 0px; white-space: pre-wrap; overflow: visible; padding-bottom: 0px; word-break: break-word; font-family: Poppins; font-size: 14px; font-weight: 400; color: rgb(60, 60, 59); letter-spacing: 0.5px; line-height: 1; border-radius: 0px; opacity: 1;\">Home</div>\n" +
    "      </div>\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex column clickable-element\" style=\"z-index: 3; align-self: flex-start; min-width: 0px; order: 2; min-height: 50px; width: 0px; flex-grow: 1; height: max-content; margin: 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "        <div class=\"bubble-element HTML\" style=\"z-index: 3; align-self: center; min-width: 24px; max-width: 24px; order: 1; min-height: 24px; max-height: 24px; height: 24px; flex-grow: 1; width: 24px; margin: 0px 0px 10px; border-radius: 0px; opacity: 1;\">\n" +
    "          <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    ...
    "          </svg>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Text\" style=\"z-index: 7; align-self: center; min-width: 0px; order: 2; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: auto; margin: 0px; white-space: pre-wrap; overflow: visible; padding-bottom: 0px; word-break: break-word; font-family: Poppins; font-size: 14px; font-weight: 400; color: rgb(60, 60, 59); letter-spacing: 0.5px; line-height: 1; border-radius: 0px; opacity: 1;\">My ADS</div>\n" +
    "      </div>\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex column clickable-element\" style=\"z-index: 4; align-self: flex-start; min-width: 0px; order: 3; min-height: 50px; width: 0px; flex-grow: 1; height: max-content; margin: 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "        <div class=\"bubble-element HTML\" style=\"z-index: 4; align-self: center; min-width: 24px; max-width: 24px; order: 1; min-height: 24px; max-height: 24px; height: 24px; flex-grow: 1; width: 24px; margin: 0px 0px 10px; border-radius: 0px; opacity: 1;\">\n" +
    "          <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    ...
    "          </svg>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Text\" style=\"z-index: 7; align-self: center; min-width: 0px; order: 2; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: auto; margin: 0px; white-space: pre-wrap; overflow: visible; padding-bottom: 0px; word-break: break-word; font-family: Poppins; font-size: 14px; font-weight: 400; color: rgb(60, 60, 59); letter-spacing: 0.5px; line-height: 1; border-radius: 0px; opacity: 1;\">Settings</div>\n" +
    "      </div>\n" +
    "      <div class=\"bubble-element Group bubble-r-container flex column clickable-element\" style=\"z-index: 5; align-self: flex-start; min-width: 0px; order: 4; min-height: 50px; width: 0px; flex-grow: 1; height: max-content; margin: 0px; justify-content: flex-start; overflow: visible; border-radius: 0px; opacity: 1; cursor: pointer;\">\n" +
    "        <div class=\"bubble-element HTML\" style=\"z-index: 5; align-self: center; min-width: 24px; max-width: 24px; order: 1; min-height: 24px; max-height: 24px; height: 24px; flex-grow: 1; width: 24px; margin: 0px 0px 10px; border-radius: 0px; opacity: 1;\">\n" +
    "          <svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
    ...
    "          </svg>\n" +
    "        </div>\n" +
    "        <div class=\"bubble-element Text\" style=\"z-index: 7; align-self: center; min-width: 0px; order: 2; min-height: 0px; height: max-content; flex-grow: 0; flex-shrink: 0; width: auto; margin: 0px; white-space: pre-wrap; overflow: visible; padding-bottom: 0px; word-break: break-word; font-family: Poppins; font-size: 14px; font-weight: 400; color: rgb(60, 60, 59); letter-spacing: 0.5px; line-height: 1; border-radius: 0px; opacity: 1;\">Profile</div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "    <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 9; order: 2; height: max-content; flex-shrink: 0; justify-content: space-between; overflow: visible; border-radius: 0px; opacity: 1; align-self: flex-start; min-width: 300px; max-width: 1180px; min-height: 0px; flex-grow: 0; width: calc(100% - 20px); margin: 46px 10px 36px;\">\n" +
    ...
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"bubble-element GroupFocus bubble-r-container flex row\" style=\"visibility: hidden; display: none; position: absolute; min-width: 0px; max-width: 200px; min-height: 0px; height: auto; right: 20px; bottom: unset; z-index: 2005; margin-right: auto; overflow-y: auto; justify-content: center;\">\n" +
    "  <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "    <div class=\"bubble-element RepeatingGroup\" style=\"z-index: 2; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px;\"></div>\n" +
    "  </div>\n" +
    "</div>\n" +
    "<div class=\"bubble-element GroupFocus bubble-r-container flex row\" style=\"visibility: hidden; display: none; position: absolute; min-width: 0px; max-width: 280px; min-height: 0px; height: auto; right: 20px; bottom: unset; z-index: 2005; margin-right: auto; overflow-y: auto; justify-content: center;\">\n" +
    "  <div class=\"bubble-element Group bubble-r-container flex row\" style=\"z-index: 2; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px; justify-content: flex-start;\">\n" +
    "    <div class=\"bubble-element RepeatingGroup\" style=\"z-index: 2; align-self: flex-start; min-width: 0px; order: 1; min-height: 0px; width: 0px; flex-grow: 1; height: max-content; margin: 0px;\"></div>\n" +
    "  </div>\n" +
    "</div>\n" +
    ...
    "    <div class=\"bubble-element Group bubble-r-container flex row\" style=\"visibility: hidden; z-index: 8; align-self: flex-start; min-width: 0px; max-width: 344px; order: 1; min-height: 40px; height: max-content; flex-grow: 0; flex-shrink: 0; width: calc(100% - 0px); margin: 0px; justify-content: center; display: none;\">\n" +
